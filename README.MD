...
Pretty much self-explanatory, but the file property is the name of the file inside /lists and the name is the display name for the list on the first screen of the app.
